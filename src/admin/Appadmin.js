    ...
    <div className="App">
      <Router>
        <Switch>
          ...
          <Route exact path="/AddSneakers" component={() => <Container><AddProduct id="1" /></Container>} />
          <Route exact path="/Addtravisscott" component={() => <Container><AddProduct id="5" /></Container>} />
          <Route exact path="/Addstreetwear" component={() => <Container><AddProduct id="2" /></Container>} />
          <Route exact path="/AddKith" component={() => <Container><AddProduct id="4" /></Container>} />
          <Route exact path="/AddKaws" component={() => <Container><AddProduct id="3" /></Container>} />
